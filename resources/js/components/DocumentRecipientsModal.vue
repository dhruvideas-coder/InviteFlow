                                ...
                                <table class="table min-w-[580px]">
                                    ...
                                    <tbody v-if="loading">
                                        <tr v-for="i in 5" :key="i">
                                            <td :colspan="lang.currentLocale === 'en' ? 6 : 5" class="py-5">
                                    ...
                                    <tbody v-else>
                                        ...
                                        <tr v-if="!loading && !recipients.length">
                                            <td :colspan="lang.currentLocale === 'en' ? 6 : 5" class="text-center py-20">
                            ...
                            <div class="modal max-w-3xl w-[96%] max-h-[95vh] flex flex-col p-0 overflow-hidden">
                                ...
                                <div class="flex-1 overflow-y-auto p-5 space-y-5">
                                    ...
                                    <div v-else class="relative">
                                        <select v-model="previewDocSelectedId" class="select w-full pl-11 h-11 appearance-none">
